...
public interface ReadingListItemMapper {
        ...
        @Mapping(target = "priority", expression = "java(dto.priority() != null ? ReadingListItem.Priority.valueOf(dto.priority().toUpperCase()) : ReadingListItem.Priority.MEDIUM)")
        @Mapping(target = "difficulty", expression = "java(dto.difficulty() != null ? ReadingListItem.Difficulty.valueOf(dto.difficulty().toUpperCase()) : ReadingListItem.Difficulty.MEDIUM)")
        @Mapping(target = "relevance", expression = "java(dto.relevance() != null ? ReadingListItem.Relevance.valueOf(dto.relevance().toUpperCase()) : ReadingListItem.Relevance.MEDIUM)")
        ...
        @Mapping(target = "status", expression = "java(dto.status() != null ? ReadingListItem.Status.valueOf(dto.status().toUpperCase()) : entity.getStatus())")
        @Mapping(target = "priority", expression = "java(dto.priority() != null ? ReadingListItem.Priority.valueOf(dto.priority().toUpperCase()) : entity.getPriority())")
        @Mapping(target = "difficulty", expression = "java(dto.difficulty() != null ? ReadingListItem.Difficulty.valueOf(dto.difficulty().toUpperCase()) : entity.getDifficulty())")
        @Mapping(target = "relevance", expression = "java(dto.relevance() != null ? ReadingListItem.Relevance.valueOf(dto.relevance().toUpperCase()) : entity.getRelevance())")
        @Mapping(target = "estimatedTime", source = "dto.estimatedTime")
        @Mapping(target = "actualTime", source = "dto.actualTime")
        @Mapping(target = "notes", source = "dto.notes")
        @Mapping(target = "tags", source = "dto.tags")
        @Mapping(target = "rating", source = "dto.rating")
        @Mapping(target = "readingProgress", expression = "java(dto.readingProgress() != null ? dto.readingProgress() : entity.getReadingProgress())")
        @Mapping(target = "readCount", ignore = true) // Don't update read count
        @Mapping(target = "isBookmarked", expression = "java(dto.isBookmarked() != null ? dto.isBookmarked() : entity.getIsBookmarked())")
